def get():
    return [
            ...
            [
                [
                    ' - бот написанный с нуля на Python. Пока он находится в разработке, постепенно добавляя свои новые функции. Developed by Tinelix. [Пригласить](https://discord.com/api/oauth2/authorize?client_id=785383439196487720&permissions=8&scope=bot)\n\n`=help` `=state` `=profile` `=settings` `=tnews`'
                ],
                [
                    'Состояние бота',
                    'Задержка',
            ...
            [
                'Профили',
                '`=profile -u [ID]` - узнать информацию о пользователе.\n`=profile -g` - узнать информацию о сервере',
                '**Свои параметры** (изменить можно в `=settings`)**:**\n',
            ...
            [ # 1.7
                'Обратный отсчет до Нового года', # 1.7.0
                ' дн., ', # 1.7.1
                ' ч., ', # 1.7.2
                ' мин. ', # 1.7.3
                ' с. (для Вашего часового пояса)', # 1.7.4
                ' с.', # 1.7.5
                ' (Москва, UTC+3:00)', # 1.7.6
                ' (Екатеринбург/Челябинск, UTC+5:00)', # 1.7.7
                ' (Новосибирск/Барнаул, UTC+7:00)', # 1.7.8
                ' (Улан-Удэ, UTC+8:00)', # 1.7.9
                'Отсчет в других городах', # 1.7.10
                '_**Новый год в Москве уже наступил!**_', # 1.7.11
                '_**Новый год в Челябинске и Екатеринбурге уже наступил!**_', # 1.7.12
                '_**Новый год в Новосибирске и Барнауле уже наступил!**_', # 1.7.13
                '_**Новый год в Улан-Удэ уже наступил!**_' # 1.7.14      
            ],
            [ # 1.8
