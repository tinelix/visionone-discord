...
def get():
    ...
    return [
            ...
            [
                [
                    ' - простой и немного расширяемый. Developed by Tinelix. **Префикс:** `{0}`{1}\n\n**А Вы знаете, что...** {2}',
                  [ # 1.0.1
                    'Основное', # 1.0.1.0
            ...
            [ # 1.15
              ...
              '[Пригласить бота](https://discord.com/oauth2/authorize?client_id=769515555765616690&permissions=8&scope=bot)\n[GitHub](https://github.com/tinelix/visionbot)\n[ВКонтакте](https://vk.com/tinelix)\n[YouTube](https://www.youtube.com/channel/UCSPjn_Y0pLdPy6Ncb9NAdww)\n[Наш саппорт-сервер](https://discord.gg/HAt6K2QuJU)'
            ],
            [ # 1.16
              'Голосование', # 1.16.0
